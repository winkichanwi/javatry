...
public class Step01VariableTest extends PlainTestCase {
    ...
    public void test_variable_instance_variable_default_int() {
        ...
        log(sea); // your answer? => 0 // NOTE(winkichanwi) primitive type
    }
    ...
    private void helpInstanceVariableViaMethod(String instanceMagiclamp) { // NOTE(winkichanwi) 参照を渡すではないため、次はローカルスコープになる
        instanceBroadway = "bigband";
        ++instanceDockside;
        instanceMagiclamp = "burn"; // NOTE(winkichanwi) ローカルスコープで、そして、副作用を返していない
    }
    ...
    private void helpMethodArgumentMethodcall(StringBuilder sea, int land) {
        ++land;
        sea.append(land); // NOTE(winkichanwi) StringBuilderが副作用を受けている
    }
